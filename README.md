...
To reproduce data analysis, download items 2-4 into the same directory and using R (or R studio) source(‘PEBBLE_Analysis.R’).  The script will install teh necessary packages and run the analysis.  The results will be generated in a PEBBLE_Analysis.html file (produced in the same directory) which can be opened with a web browser.
